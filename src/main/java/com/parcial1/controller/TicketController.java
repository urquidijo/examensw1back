...
public class TicketController {
    ...
    @GetMapping("/tasks")
    public ResponseEntity<List<WorkflowTaskResponse>> getProjectTasks(@PathVariable String projectId) {
        return ResponseEntity.ok(ticketService.getProjectTasks(projectId));
    }
}